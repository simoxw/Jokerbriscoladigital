    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen space-y-8 p-6 text-center w-full max-w-sm">
            ...
            <div className="flex flex-col gap-3 w-full">
                {installPrompt && (
                    <button onClick={handleInstall} className="py-3 bg-indigo-600 hover:bg-indigo-500 rounded-2xl font-bold text-sm shadow-xl transition-all uppercase tracking-widest border-b-4 border-indigo-800 flex items-center justify-center gap-2">
